...
export class FormComponent {
  ...
  modules = [
    {name: 'Module 1', abbreviation: 'M1'},
    {name: 'Module 2', abbreviation: 'M2'},
    {name: 'Module 3', abbreviation: 'M3'},
    {name: 'Module 4', abbreviation: 'M4'},
    {name: 'Module 5', abbreviation: 'M5'},
  ...
  questionTypes = [
    {name: 'Short Note', abbreviation: 'ShortNote'},
    {name: 'Differentiate', abbreviation: 'Differentiate'},
    {name: 'Brief', abbreviation: 'BRIF'},
    {name: 'Numerical', abbreviation: 'NUM'},
  ];
  difficultyLevels = [
    {name: 'Easy', abbreviation: 'EZY'},
    {name: 'Moderate', abbreviation: 'MOD'},
    {name: 'Hard', abbreviation: 'HRD'},
    
    
  ];
  taxonomyLevels = [
    {name: 'Evaluation', abbreviation: 'EVAL'},
    {name: 'Understanding', abbreviation: 'UND'},
  ...
  constructor(
    ...
    private questService: AddQuestionService
    ) {}
  ...
  onSubmit() {
    if(this.addressForm.valid){
      ...
      const quesData = {
        ...
        question: this.addressForm.value.question,
        difficultyLevel: this.addressForm.value.difficultyLevel,
        module: this.addressForm.value.module,
        typeofQuestion: this.addressForm.value.questionType
      }

      console.log(quesData)

      this.questService.addQuestion(quesData)
      .subscribe(
        res => console.log(res),
        err => console.log(err)
      )
